    ...
    <div className="max-w-7xl mx-auto px-4 py-8 text-white">
      ...
      <div className="bg-gradient-to-r from-indigo-900 to-purple-900 rounded-3xl p-8 md:p-16 text-white shadow-[0_0_50px_rgba(79,70,229,0.2)] relative overflow-hidden mb-16 border border-white/10 group">
        ...
        <div className="relative z-10 max-w-2xl">
          <div className="inline-block bg-yellow-500/20 text-yellow-300 px-4 py-1 rounded-full text-sm font-bold mb-4 border border-yellow-500/50">
              🚀 עונה חדשה: מאסטרים בחשבון
          </div>
          <h1 className="text-5xl md:text-7xl font-black mb-6 leading-tight drop-shadow-xl dir-rtl">
            מוכנים <br/>
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-purple-400">לעלות רמה?</span>
          </h1>
          <p className="text-xl md:text-2xl text-slate-300 mb-10 font-light leading-relaxed dir-rtl">
             הצטרפו למשחקי החשבון הגדולים. שחקו, צברו XP, שברו שיאים ופתחו הישגים חדשים בעזרת ה-AI.
          </p>
          <button 
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div onClick={() => setPage('game')} className="glass-card p-8 rounded-3xl hover:bg-slate-800 transition-all cursor-pointer group hover:-translate-y-2 relative overflow-hidden">
          ...
          <h3 className="text-2xl font-black text-white mb-3">אזור המשחקים</h3>
          <p className="text-slate-400 mb-6 leading-relaxed">מצבי משחק מהירים: משחק הזיכרון, חידון בוס, מרוץ נגד השעון ומגדל השמיים.</p>
          <span className="text-red-400 font-bold flex items-center text-sm tracking-wider">כנס לאזור <ChevronLeft size={16} /></span>
        </div>
        ...
        <div onClick={() => setPage('tutor')} className="glass-card p-8 rounded-3xl hover:bg-slate-800 transition-all cursor-pointer group hover:-translate-y-2 relative overflow-hidden">
          ...
          <h3 className="text-2xl font-black text-white mb-3">מאמן אישי (AI)</h3>
          <p className="text-slate-400 mb-6 leading-relaxed">הבוט "Numbery" יעזור לכם לפצח כל אתגר עם רמזים וטיפים.</p>
          <span className="text-purple-400 font-bold flex items-center text-sm tracking-wider">דבר עכשיו <ChevronLeft size={16} /></span>
        </div>
         ...
         <div onClick={() => setPage('lab')} className="glass-card p-8 rounded-3xl hover:bg-slate-800 transition-all cursor-pointer group hover:-translate-y-2 relative overflow-hidden">
          ...
          <h3 className="text-2xl font-black text-white mb-3">מעבדה ויזואלית</h3>
          <p className="text-slate-400 mb-6 leading-relaxed">חקרו שברים, כפל וצורות עם הדמיות תלת-ממדיות אינטראקטיביות.</p>
          <span className="text-green-400 font-bold flex items-center text-sm tracking-wider">פתח מעבדה <ChevronLeft size={16} /></span>
        </div>
